...
const typeDefs = gql`
    ...
    type Mutation {
        ...
        updateRecipe(_id: String!, title: String!, ingredients: [String!], description: String!, instructions: [String!], total_time: String!, dietary_restrictions: [String], link: String): User
